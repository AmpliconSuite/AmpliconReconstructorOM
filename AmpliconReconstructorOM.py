...
if __name__ == '__main__':
	...
	parser.add_argument("--visualize_scaffolds",default=False,action='store_true',help="Produce visualizations for the single unconnected scaffolds")
	...
	for i in samples_to_run:
		...
		if not args.noAlign:
			...
			run_ARAD(segs_path, contigs_path, graph_path, enzyme, min_map_len, inst, i, rpi, optionalFlagString)
